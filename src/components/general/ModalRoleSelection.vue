      ...
      <div class="flex justify-center items-center h-full w-full">
        ...
        <div v-else class="bg-primary-bg rounded-lg py-5 px-6 max-w-xs md:max-w-3xl relative">
          ...
          <div class="flex flex-row gap-x-3 max-w-3xl">
            ...
            >
              <img
                :src="`src/assets/images/home/${role.filePath}`"
                :alt="`系統展示 - ${role.name}端進入頁面`"
              />
      ...
      roles: [
        {
          name: '顧客',
          path: '/client',
          filePath: 'home-demo-role-client.png'
        },
        {
          name: '店員',
          path: '/staff/login',
          filePath: 'home-demo-role-staff.png'
        },
        {
          name: '店長',
          path: '/admin/login',
          filePath: 'home-demo-role-admin.png'
        }
      ]
    }
  },
