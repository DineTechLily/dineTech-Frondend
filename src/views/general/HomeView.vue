<template>
  ...
  <section
    class="bg-primary-bg md:bg-[url('@/assets/images/home/home-bg-landing.png')] bg-no-repeat bg-cover"
  >
    <div
      class="reveal-content px-3 sm:px-10 lg:px-20 2xl:px-60 mx-auto h-[calc(100vh-64px)] md:h-[calc(100vh-72px)] flex flex-col"
    >
      <div class="flex justify-between flex-col md:flex-row items-center pt-6 md:pt-10">
        ...
        <img class="mt-6 md:mt-8" :src="bannerPath.landing" alt="DineTech 宣傳橫幅" />
      </div>
  ...
  >
    ...
    >
      <ul class="reveal-content flex flex-col gap-y-6 md:gap-y-8 py-6 px-3 md:p-12">
        ...
        >
          <img :src="`src/assets/images/home/${feature.iconPath}`" alt="產品特色一裝飾圖示" />
      ...
      <img class="object-fill self-stretch" :src="bannerPath.feature" alt="產品特色直幅" />
    </div>
  </section>
  <section class="px-3 sm:px-10 lg:px-20 2xl:px-60 mx-auto py-6 md:py-12 border-b border-gray-e9">
    ...
    >
      <img class="object-fill self-stretch" :src="bannerPath.experience" alt="產品體驗直幅" />
      <div
      ...
      >
        ...
        <div class="reveal-content flex flex-col items-start p-6 pt-4 md:pt-6 md:px-9 md:pb-10">
          ...
          <div class="flex flex-col gap-y-2 md:gap-y-3 mb-7 min-h-[108px] md:min-h-[132px]">
            <p v-for="item in plan.offerings" class="flex items-center gap-x-3.5">
              <span
  ...
  <section class="px-3 sm:px-10 lg:px-20 2xl:px-60 mx-auto py-6 md:py-12 border-b border-gray-e9">
    ...
    >
      <img class="object-fill self-stretch" :src="bannerPath.management" alt="功能特點直幅" />
      <div
      ...
      >
        <ul class="flex flex-col gap-y-6 md:gap-y-8">
          ...
          >
            <img :src="`src/assets/images/home/${feature.iconPath}`" alt="功能特點圖示" />
            <div class="flex flex-col items-center md:items-start md:ps-6">
  ...
  >
    ...
    <div class="flex justify-center items-center rounded-3xl">
      <img class="object-fill self-stretch" :src="bannerPath.support" alt="技術支援橫幅" />
    </div>
  </section>
  <section
    class="px-3 sm:px-10 lg:px-20 2xl:px-60 mx-auto py-6 md:py-12 border-b border-gray-e9 bg-primary-bg relative"
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      managementFeatures: [
        {
          iconPath: 'home-icon-management-order-1.png',
          title: '資訊彙整，多重顯示',
          description:
            '隨時都可快速瀏覽每日訂候位列表、桌位圖以及顧客資訊，訂位從各平台串連，皆多重顯示，一覽無遺。'
        },
        {
          iconPath: 'home-icon-management-order-2.png',
          title: '⾃動確認訂位',
          description: '顧客用餐前，系統再次自動寄送簡訊進行確認，降低人為疏失，訂位管理更有效率。'
        },
        {
          iconPath: 'home-icon-management-order-3.png',
          title: '顧客資料庫',
          description:
            '餐廳可隨時調閱顧客跨餐廳、跨分店消費記錄，每筆訂候位都會存入後台，建立餐飲業龐大資料庫。'
        },
        {
          iconPath: 'home-icon-management-order-4.png',
          title: '記錄顧客喜好',
          description:
            '這位客人不吃辣？這位客人喜歡坐室外？DineTech 全部幫你記錄起來，餐廳可自訂客人喜好，往後對回頭客的新進訂候位就可以貼心應對！'
        },
        {
          iconPath: 'home-icon-management-order-5.png',
          title: '統計數據管理',
          description:
  ...
  computed: {
    bannerPath(): BannerPath {
      ...
      const path: string = `/src/assets/images/home/${folder}`

      return {
        landing: `${path}/home-banner-landing.png`,
        feature: `${path}/home-banner-feature.png`,
        support: `${path}/home-banner-support.png`,
        management: `${path}/home-banner-management.png`,
        experience: `${path}/home-banner-experience.png`,
        experience2: `${path}/home-banner-experience-02.png`
      }
    }
  },
  methods: {
